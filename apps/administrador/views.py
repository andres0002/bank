...
from apps.SenaSoftApp.forms import AdicionarClienteForm
...
class ListadoClientes(LoginRequiredMixin, View):
    login_url = '/'
    template_name = 'administrador/listar_clientes.html'
    form_class = ClienteForm
...
class ListadoClientesReporte(LoginRequiredMixin, View):
    login_url = '/'
    template_name = 'administrador/listar_clientes_reporte.html'
    form_class = ClienteForm
...
class ListadoCuentas(LoginRequiredMixin, View):
    login_url = '/'
    template_name = 'administrador/listar_cuentas.html'
...
class ListadoCuentasReporte(LoginRequiredMixin, View):
    login_url = '/'
    template_name = 'administrador/listar_cuentas_reporte.html'
...
class ListadoCuentasReporteCliente(LoginRequiredMixin, View):
    login_url = '/'
    template_name = 'administrador/listar_cuentas_reporte_cliente.html'
...
class AdicionarCliente(LoginRequiredMixin, View):
    ...
    template_name = 'administrador/adicionar_cliente.html'
...
class VisualizarCliente(LoginRequiredMixin, View):
    login_url = '/'
    form_class = ClienteForm
    template_name = 'administrador/visualizar_cliente.html'
...
class VisualizarClienteHipervinculo(LoginRequiredMixin, View):
    login_url = '/'
    form_class = ClienteForm
    template_name = 'administrador/visualizar_cliente_hipervinculo.html'
...
class VisualizarClienteCuentaHipervinculo(LoginRequiredMixin, View):
    login_url = '/'
    form_class = ClienteForm
    template_name = 'administrador/visualizar_cuenta_cliente_hipervinculo.html'
...
class ModificarCliente(LoginRequiredMixin, View):
    login_url = '/'
    form_class = ClienteForm
    template_name = 'administrador/modificar_cliente.html'
...
class BorrarCliente(LoginRequiredMixin, View):
    login_url = '/'
    form_class = ClienteForm
    template_name = 'administrador/borrar_cliente.html'
...
class AdicionarCuenta(LoginRequiredMixin, View):
    ...
    template_name = 'administrador/adicionar_cuenta.html'
...
class VisualizarCuenta(LoginRequiredMixin, View):
    login_url = '/'
    form_class = CuentaForm
    template_name = 'administrador/visualizar_cuenta.html'
...
class ModificarCuenta(LoginRequiredMixin, View):
    login_url = '/'
    form_class = CuentaForm
    template_name = 'administrador/modificar_cuenta.html'
...
class BorrarCuenta(LoginRequiredMixin, View):
    login_url = '/'
    form_class = CuentaForm
    template_name = 'administrador/borrar_cuenta.html'
...
class ListadoMovimientosReporte(LoginRequiredMixin, View):
    login_url = '/'
    template_name = 'administrador/listar_movimientos_reporte.html'
...
class ListadoMovimientos(LoginRequiredMixin, View):
    login_url = '/'
    template_name = 'administrador/listar_movimientos.html'
    form_class = MovimientoForm
...
class ListadoMovimientosGeneral(LoginRequiredMixin, View):
    login_url = '/'
    template_name = 'administrador/listar_movimientos_general.html'
    form_class = MovimientoForm
...
class ListadoMovimientosReporteByDate(LoginRequiredMixin, View):
    login_url = '/'
    template_name = 'administrador/listar_movimientos_by_fecha.html'
...
class ListadoMovimientosReporteByFecha(LoginRequiredMixin, View):
    template_name = 'administrador/listar_movimientos_por_fecha.html'
...
class VisualizarMovimiento(LoginRequiredMixin, View):
    login_url = '/'
    form_class = MovimientoForm
    template_name = 'administrador/visualizar_movimientos.html'
