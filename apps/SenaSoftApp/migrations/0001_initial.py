    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo_ciudad', models.ForeignKey(max_length=10, on_delete=django.db.models.deletion.CASCADE, to='SenaSoftApp.ciudad')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SenaSoftApp.cliente')),
            ],
            options={
                'verbose_name': 'Cuenta',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SenaSoftApp.cliente')),
                ('codigo_cuenta', models.ForeignKey(max_length=10, on_delete=django.db.models.deletion.CASCADE, to='SenaSoftApp.cuenta')),
            ],
            options={
